...
public class VistaProductoCompletoService {
    ...
    public Page<VistaProductoCompletoDTO> findAllByFilters(String nombre, Long categoriaId, Long marcaId,
            Pageable pageable) {
        String nombreParam = nombre == null ? null : "%" + nombre + "%";
        return repository.findAllByFilters(nombreParam, categoriaId, marcaId, pageable);
    }
}